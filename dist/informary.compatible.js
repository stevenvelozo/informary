...
pRecordObject[this._NonHTMLStateProperty]=this._NonHTMLState;this._Dependencies.jquery.each(tmpFormValueElements,function(pRecordIndex,pRecordAddress){var tmpFormValueAddress=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-datum');var tmpFormContainerAddress=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-container');var tmpFormContainerIndex=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-index');var tmpFormContainerGUID=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-guid');var tmpFormValue;// check to see which element type this is before trying to collect the value
