...
},{key:"getNode",value:function getNode(pHash){if(!this._HashMap.hasOwnProperty(pHash))return false;return this._HashMap[pHash];}}]);return CashMoney;}();module.exports=CashMoney;},{"./LinkedList.js":3}],2:[function(require,module,exports){/**
...
this.__ISNODE=true;});module.exports=LinkedListNode;},{}],3:[function(require,module,exports){"use strict";/**
...
},{key:"seek",value:function seek(pNodeIndex){if(!pNodeIndex)return false;if(this.length<1)return false;if(pNodeIndex>=this.length)return false;var tmpNode=this.head;for(var i=0;i<pNodeIndex;i++){tmpNode=tmpNode.RightNode;}return tmpNode;}}]);return LinkedList;}();module.exports=LinkedList;},{"./LinkedList-Node.js":2}],4:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=void 0;var _utils=require("./utils.js");var addedDiff=function addedDiff(lhs,rhs){if(lhs===rhs||!(0,_utils.isObject)(lhs)||!(0,_utils.isObject)(rhs))return{};var l=lhs;var r=rhs;return Object.keys(r).reduce(function(acc,key){if((0,_utils.hasOwnProperty)(l,key)){var difference=addedDiff(l[key],r[key]);if((0,_utils.isObject)(difference)&&(0,_utils.isEmpty)(difference))return acc;acc[key]=difference;return acc;}acc[key]=r[key];return acc;},{});};var _default=addedDiff;exports["default"]=_default;},{"./utils.js":10}],5:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=void 0;var _utils=require("./utils.js");var deletedDiff=function deletedDiff(lhs,rhs){if(lhs===rhs||!(0,_utils.isObject)(lhs)||!(0,_utils.isObject)(rhs))return{};var l=lhs;var r=rhs;return Object.keys(l).reduce(function(acc,key){if((0,_utils.hasOwnProperty)(r,key)){var difference=deletedDiff(l[key],r[key]);if((0,_utils.isObject)(difference)&&(0,_utils.isEmpty)(difference))return acc;acc[key]=difference;return acc;}acc[key]=undefined;return acc;},{});};var _default=deletedDiff;exports["default"]=_default;},{"./utils.js":10}],6:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=void 0;var _added=_interopRequireDefault(require("./added.js"));var _deleted=_interopRequireDefault(require("./deleted.js"));var _updated=_interopRequireDefault(require("./updated.js"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}var detailedDiff=function detailedDiff(lhs,rhs){return{added:(0,_added["default"])(lhs,rhs),deleted:(0,_deleted["default"])(lhs,rhs),updated:(0,_updated["default"])(lhs,rhs)};};var _default=detailedDiff;exports["default"]=_default;},{"./added.js":4,"./deleted.js":5,"./updated.js":9}],7:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=void 0;var _utils=require("./utils.js");var diff=function diff(lhs,rhs){if(lhs===rhs)return{};// equal return no diff
if(!(0,_utils.isObject)(lhs)||!(0,_utils.isObject)(rhs))return rhs;// return updated rhs
var l=lhs;var r=rhs;var deletedValues=Object.keys(l).reduce(function(acc,key){if(!(0,_utils.hasOwnProperty)(r,key)){acc[key]=undefined;}return acc;},{});if((0,_utils.isDate)(l)||(0,_utils.isDate)(r)){if(l.valueOf()==r.valueOf())return{};return r;}return Object.keys(r).reduce(function(acc,key){if(!(0,_utils.hasOwnProperty)(l,key)){acc[key]=r[key];// return added r key
return acc;}var difference=diff(l[key],r[key]);// If the difference is empty, and the lhs is an empty object or the rhs is not an empty object
...
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery;}return jQuery;});},{}],12:[function(require,module,exports){/**
* @license MIT
* @author <steven@velozo.com>
*/ /**
* Informary browser shim loader
*/ // Load the informary module into the browser global automatically.
var libInformary=require('./Informary.js');if((typeof window==="undefined"?"undefined":_typeof(window))==='object'){window.Informary=libInformary;}module.exports=libInformary;},{"./Informary.js":14}],13:[function(require,module,exports){/**
* @license MIT
* @author <steven@velozo.com>
*/ /**
* Informary Logging
...
},{key:"logTimeDelta",value:function logTimeDelta(pTimeStamp,pMessage){var tmpMessage=typeof pMessage!=='undefined'?pMessage:'Time Measurement';var tmpEndTime=+new Date();var tmpOperationTime=tmpEndTime-pTimeStamp;this.info(tmpMessage+' ('+tmpOperationTime+'ms)');}}]);return InformaryLog;}();module.exports=InformaryLog;},{}],14:[function(require,module,exports){/**
* @license MIT
* @author <steven@velozo.com>
...
*
* @class Informary
*/var Informary=/*#__PURE__*/function(){function Informary(pSettings,pContext,pContextGUID){_classCallCheck(this,Informary);this._Dependencies={};this._Dependencies.jqueryLibrary=require('jquery');this._Settings=_typeof(pSettings)==='object'?pSettings:{// The form we are dealing with (this is a hash set on the form itself)
...
},{key:"storeRecoveryData",value:function storeRecoveryData(fCallback){var _this3=this;var tmpCallback=typeof fCallback=='function'?fCallback:function(){};var tmpRecoveryData={};this.marshalFormToData(tmpRecoveryData,function(){_this3._RecoveryDocumentState=tmpRecoveryData;return tmpCallback(_this3.writeData('Recovery',_this3._RecoveryDocumentState));});}},{key:"snapshotData",value:function snapshotData(){var _this4=this;var tmpNewUndoKey=Date.now().toString();// Check to see if there are any changes to the data to be stored
var tmpOldRecoveryState=JSON.stringify(this._RecoveryDocumentState);this.storeRecoveryData(function(){if(tmpOldRecoveryState!=JSON.stringify(_this4._RecoveryDocumentState)){if(_this4._Settings.DebugLog){_this4.log.debug("Creating recovery snapshot at [".concat(tmpNewUndoKey,"]..."));}// Destroy all data in the redo ring, because this new snapshot invalidates it.
while(_this4._RedoKeys.length>0){var tmpRedoKey=_this4._RedoKeys.pop();_this4._RedoBuffer.expire(tmpRedoKey);}_this4._UndoKeys.push(tmpNewUndoKey);_this4._UndoBuffer.put(_this4._RecoveryDocumentState,tmpNewUndoKey);}else{if(_this4._Settings.DebugLog){_this4.log.debug("Skipped creating recovery snapshot at [".concat(tmpNewUndoKey,"] because there were no changes to the recovery state..."));}}});}},{key:"snapshotDataInitial",value:function snapshotDataInitial(){var _this5=this;var tmpNewUndoKey=Date.now().toString();if(this._UndoKeys.length>0){this.log.info("Skipping creation of initial snapshot because one already exists.");return false;}this.storeRecoveryData(function(){if(_this5._Settings.DebugLog){_this5.log.debug("Creating recovery snapshot at [".concat(tmpNewUndoKey,"]..."));}_this5._UndoKeys.push(tmpNewUndoKey);_this5._UndoBuffer.put(_this5._RecoveryDocumentState,tmpNewUndoKey);});return true;}},{key:"undoSnapshotCount",value:function undoSnapshotCount(){// The initial snapshot is special to prevent confusing conditions when form data hasn't been edited.
return this._UndoKeys.length;}},{key:"redoSnapshotCount",value:function redoSnapshotCount(){return this._RedoKeys.length;}},{key:"revertToPreviousSnapshot",value:function revertToPreviousSnapshot(fCallback){var _this6=this;var tmpCallback=typeof fCallback=='function'?fCallback:function(){};if(this._UndoKeys.length<1){this.log.info("Not enough undo snapshots; skipping undo.");return tmpCallback(false);}var tmpSnapshotKey=this._UndoKeys.pop();var tmpSnapshotData=this._UndoBuffer.read(tmpSnapshotKey);if(tmpSnapshotData){// Add it to the redo buffer
...
_this6._UndoBuffer.expire(tmpSnapshotKey);_this6.marshalDataToForm(tmpSnapshotData,function(){_this6._RecoveryDocumentState=tmpSnapshotData;_this6.log.info("Informary reverted to snapshot ID ".concat(tmpSnapshotKey));if(JSON.stringify(tmpCurrentFormData)==JSON.stringify(tmpSnapshotData)&&_this6._UndoKeys.length>0){return _this6.revertToPreviousSnapshot(tmpCallback);}if(_this6._UndoKeys.length==0){_this6.log.info("Snapshot Data Depleted -- Creating Extra Undo Snapshot");_this6.snapshotDataInitial();}return tmpCallback(true);});});}return tmpCallback(false);}},{key:"reapplyNextRevertedSnapshot",value:function reapplyNextRevertedSnapshot(fCallback){var _this7=this;var tmpCallback=typeof fCallback=='function'?fCallback:function(){};var tmpSnapshotKey=this._RedoKeys.pop();var tmpSnapshotData=this._RedoBuffer.read(tmpSnapshotKey);if(tmpSnapshotData){// Add it to the undo buffer
...
var tmpCurrentFormData={};this.marshalFormToData(tmpCurrentFormData,function(){_this7.marshalDataToForm(tmpSnapshotData,function(){_this7._RecoveryDocumentState=tmpSnapshotData;_this7.log.info("Informary reapplied snapshot ID ".concat(tmpSnapshotKey));if(JSON.stringify(tmpCurrentFormData)==JSON.stringify(tmpSnapshotData)&&_this7._RedoKeys.length>0){// If the old form data matches the applied data, roll back farther
return _this7.reapplyNextRevertedSnapshot(tmpCallback);}return tmpCallback(true);});});}return tmpCallback(false);}},{key:"clearRecoveryData",value:function clearRecoveryData(){return this.deleteData('Recovery');}},{key:"readRecoveryData",value:function readRecoveryData(){return this.readData('Recovery');}},{key:"restoreRecoveryScenarioData",value:function restoreRecoveryScenarioData(fCallback){var _this8=this;var tmpCallback=typeof fCallback=='function'?fCallback:function(){};var tmpRecoveryScenarioData=this.readRecoveryScenario();if(tmpRecoveryScenarioData&&tmpRecoveryScenarioData.ExistingRecovery){this.marshalDataToForm(tmpRecoveryScenarioData.ExistingRecovery,function(){_this8.clearRecoveryScenarioData();// Store a new recovery data
...
tmpRecoveryData.Index={};tmpRecoveryData.Index.ExistingSource=this.readIndexValue('Source');tmpRecoveryData.Index.ExistingRecovery=this.readIndexValue('Recovery');this.writeData('RecoveryScenario',tmpRecoveryData);return tmpRecoveryData;}}}},{key:"compareCurrentStateToUndoAndRedo",value:function compareCurrentStateToUndoAndRedo(fCallback){var _this9=this;var tmpCallBack=typeof fCallback==='function'?fCallback:function(){};var tmpCurrentStateData={};var tmpCurrentUndoObject={};var tmpCurrentRedoObject={};this.marshalFormToData(tmpCurrentStateData,function(){var tmpCurrentStateDataJSON=JSON.stringify(tmpCurrentStateData);if(_this9._UndoKeys.length>0){var tmpCurrentUndoBufferSnapshotKey=_this9._UndoKeys[_this9._UndoKeys.length-1];tmpCurrentUndoObject=_this9._UndoBuffer.read(tmpCurrentUndoBufferSnapshotKey);}if(_this9._RedoKeys.length>0){// Because there can be duplication of records in the redo buffer that may include
...
var tmpFirstRedoIndexWithDifferences=_this9._RedoKeys.length-1;for(var i=_this9._RedoKeys.length-1;i>=0;i--){var tmpRedoComparisonJSON=JSON.stringify(_this9._RedoBuffer.read(_this9._RedoKeys[i]));if(tmpRedoComparisonJSON!=tmpCurrentStateDataJSON){tmpFirstRedoIndexWithDifferences=i;// Once we have found a set of redo data that doesn't match, we don't want to keep looking
break;}}tmpCurrentRedoObject=_this9._RedoBuffer.read(_this9._RedoKeys[tmpFirstRedoIndexWithDifferences]);}var tmpComparisonData={UndoDelta:libObjectDiff.detailedDiff(tmpCurrentStateData,tmpCurrentUndoObject),UndoGUIDDelta:{Added:[],Deleted:[]},RedoDelta:libObjectDiff.detailedDiff(tmpCurrentStateData,tmpCurrentRedoObject),RedoGUIDDelta:{Added:[],Deleted:[]}};// Perform GUID diff operations
...
for(var _i2=tmpUndoDataIndex;_i2<=tmpUndoDataMaxIndex;_i2++){tmpComparisonData.UndoGUIDDelta.Added.push(tmpUndoGUIDElements[_i2]);}// Get the deltas for Redo data
...
for(var _i3=tmpRedoDataIndex;_i3<=tmpRedoDataMaxIndex;_i3++){tmpComparisonData.RedoGUIDDelta.Added.push(tmpRedoGUIDElements[_i3]);}tmpCallBack(tmpComparisonData);});}},{key:"createArrayContainers",value:function createArrayContainers(pRecordObject,fCallback,pArrayPropertyAddress){// Much simplified recursion that generates array containers
if(this._Settings.DebugLog){this.log.debug("Informary Data->Form marshalling recursive entry...");}}},{key:"marshalDataToForm",value:function marshalDataToForm(pRecordObject,fCallback,pParentPropertyAddress,pContainerPropertyAddress,pContainerIndex){var _this10=this;// Because this is recursive, we only want to call this on the outermost call of the stack.
...
_this10.marshalDataToForm(tmpRecord[i],function(){},undefined,tmpPropertyAddress,i.toString());}}else{// We've switched this to synchronous for safe browser mode
// Leaving an empty callback in there in case we decide to switch back.
return _this10.marshalDataToForm(tmpRecord,function(){},tmpPropertyAddress,tmpContainerPropertyAddress,tmpContainerPropertyIndex.toString());}break;// Ignore undefined properties
...
tmpFormElement=_this10._Dependencies.jquery("\n\t\t\t\t\t\t\t\tinput[data-i-form=\"".concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"][data-i-container=\"").concat(tmpContainerPropertyAddress,"\"][data-i-index=\"").concat(tmpContainerPropertyIndex,"\"],\n\t\t\t\t\t\t\t\tselect[data-i-form=\"").concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"][data-i-container=\"").concat(tmpContainerPropertyAddress,"\"][data-i-index=\"").concat(tmpContainerPropertyIndex,"\"],\n\t\t\t\t\t\t\t\ttextarea[data-i-form=\"").concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"][data-i-container=\"").concat(tmpContainerPropertyAddress,"\"][data-i-index=\"").concat(tmpContainerPropertyIndex,"\"]\n\t\t\t\t\t\t\t"));}else{tmpFormElement=_this10._Dependencies.jquery("\n\t\t\t\t\t\t\t\tinput[data-i-form=\"".concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"],\n\t\t\t\t\t\t\t\tselect[data-i-form=\"").concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"],\n\t\t\t\t\t\t\t\ttextarea[data-i-form=\"").concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"]\n\t\t\t\t\t\t\t"));}if(tmpFormElement.length>0){// set the text area to the text content
if(_this10._Dependencies.jquery(tmpFormElement)[0].tagName==='TEXTAREA'){_this10._Dependencies.jquery(tmpFormElement)[0].textContent=tmpRecord;// set the correct option to 'selected' for select tags
}else if(_this10._Dependencies.jquery(tmpFormElement)[0].tagName==='SELECT'){_this10._Dependencies.jquery("select[data-i-form=\"".concat(_this10._Settings.Form,"\"][data-i-datum=\"").concat(tmpPropertyAddress,"\"] option[value=\"").concat(tmpRecord,"\"]")).prop('selected',true);// otherwise just set the value for input
}else{_this10._Dependencies.jquery(tmpFormElement).val(tmpRecord);}// Check if this is a GUID value and set the data-i-guid property in it
var tmpGUIDAttribute=_this10._Dependencies.jquery(_this10).attr('data-i-guid');// For some browsers, `attr` is undefined; for others,
// `attr` is false.  Check for both.
if(typeof tmpGUIDAttribute!=='undefined'&&tmpGUIDAttribute!==false){_this10._Dependencies.jquery(tmpFormElement).attr('data-i-guid',tmpRecord);}}break;}});if(!pParentPropertyAddress){return fCallback(tmpRecoveryState);}else{return fCallback();}}},{key:"marshalFormToData",value:function marshalFormToData(pRecordObject,fCallback){var _this11=this;if(this._Settings.DebugLog){this.log.debug("Informary Form->Data marshalling recursive entry...");}// Guard against bad record objects being passed in
if(_typeof(pRecordObject)!=='object'){this.log.error('Invalid record object passed in!  Informary needs a Javascript object to put values into.');return fCallback('Invalid record object passed in!  Informary needs a Javascript object to put values into.');}var tmpFormValueElements=this._Dependencies.jquery("\n\t\t\t\tinput[data-i-form=".concat(this._Settings.Form,"],\n\t\t\t\tselect[data-i-form=").concat(this._Settings.Form,"],\n\t\t\t\ttextarea[data-i-form=").concat(this._Settings.Form,"]\n\t\t\t"));var tmpUnknownValueIndex=0;this._Dependencies.jquery.each(tmpFormValueElements,function(pRecordIndex,pRecordAddress){var tmpFormValueAddress=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-datum');var tmpFormContainerAddress=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-container');var tmpFormContainerIndex=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-index');var tmpFormContainerGUID=_this11._Dependencies.jquery(pRecordAddress).attr('data-i-guid');var tmpFormValue;// check to see which element type this is before trying to collect the value
if(_this11._Dependencies.jquery(pRecordAddress).tagName==='TEXTAREA'){tmpFormValue=_this11._Dependencies.jquery(pRecordAddress).textContent;}else{tmpFormValue=_this11._Dependencies.jquery(pRecordAddress).val();}// If the value is non existant, set it to null
if(typeof tmpFormValue==='undefined'){tmpFormValue=null;}if(typeof tmpFormValueAddress==='undefined'){tmpFormValueAddress='__ERROR.UnsetDatum.'+tmpUnknownValueIndex;tmpUnknownValueIndex++;}if(tmpFormContainerGUID){var tmpGUIDValueAddress='__GUID.'+tmpFormContainerGUID;_this11.setValueAtAddress(pRecordObject,tmpGUIDValueAddress,tmpFormContainerGUID);}if(tmpFormContainerAddress&&tmpFormContainerIndex){_this11.setValueAtAddressInContainer(pRecordObject,tmpFormContainerAddress,tmpFormContainerIndex,tmpFormValueAddress,tmpFormValue);}else{_this11.setValueAtAddress(pRecordObject,tmpFormValueAddress,tmpFormValue);}});return fCallback();}}]);return Informary;}();;module.exports=Informary;},{"./Informary-Log.js":13,"cachetrax":1,"deep-object-diff":8,"jquery":11}]},{},[12])(12);});